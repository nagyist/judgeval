...
#   timestamp: 2025-06-20T18:59:07+00:00
...
class EvalResultsFetchByProjectSortedLimit(BaseModel):
    project_name: str = Field(..., title='Project Name')
    limit: int = Field(..., title='Limit')


class DatasetDeleteExamples(BaseModel):
...
class DatasetFetchByProject(BaseModel):
    project_name: str = Field(..., title='Project Name')
...
class BatchTraceFetch(BaseModel):
    trace_ids: List[str] = Field(..., title='Trace Ids')


class TracesFetchByProject(BaseModel):
    project_name: str = Field(..., title='Project Name')
...
class TraceSpanSaveRequest(BaseModel):
    span: Dict[str, Any] = Field(..., title='Span')
    dataset_alias: str = Field(..., title='Dataset Alias')


class FetchClassifierScorersRequest(BaseModel):
...
class ClassifierScorerRequest(BaseModel):
    name: str = Field(..., title='Name')
    conversation: List[MessageItem] = Field(..., min_items=1, title='Conversation')
